...
urlpatterns = [
    ...
    path('purpose/', user_views.purpose, name='purpose'),
    ...
    path('profile/generate-coupon/', user_views.generate_coupon, name='generate-coupon'),
    path('profile/remove-coupon/', user_views.remove_coupon, name='remove-coupon'),
]
